...
def test_everyday_social_caricature_centers_women_and_lived_interaction() -> None:
    ...
    required_contract = (
        ...
        "Set every scene in mainland China, Taiwan, Hong Kong, Japan",
        "using one identity phrase from this list verbatim",
        "English-only ASCII",
        "CONTENT LEVEL",
        "At aesthetic level",
        "At erotic level",
        "At hardcore level",
        "every requested participant directly and actively involved",
        ...
        "roughly two to four times its ordinary visual scale",
        "Name both altered facial features explicitly",
        "an unquantified word such as large does not satisfy either layer",
        ...
        "a separate task does not count as participation",
        "For hardcore scenes, the explicit act is the sole ongoing human action",
        "PHYSICAL STAGING",
        "left-to-right and overlap position, body facing, weight-bearing support",
        "within anatomical reach of the stated pose",
        "Preserve one coherent occupancy map",
        "no limb passes through a body or structure",
        "no one hovers without support",
        "Deformation may change scale but never break attachment",
        "If the complete tableau cannot be reconstructed physically",
        "coherent physical staging map",
        ...
        "mixed visual media",
        "generic or interchangeable clothing",
        "a cluttered background",
        "physically irreconstructible staging",
    )
