...
- Theme 在逐字保留 required_phrases 的前提下生成完整 style，以自然句明确光向、
  软硬、色温、环境层次和氛围；最终媒介必须
  ...
  选择一个具体值而不是列出备选，并在不同 Theme 间形成协调变化。scene 确定稳定空间
  结构、两三项固定布景和关键道具身份、材质，还按已有角色名册明确人物分布；brief
