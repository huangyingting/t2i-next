...
def frame_messages(
    ...
    system = "\n".join(
        (
            ...
            "invalid. When frames_per_theme is 1, that one Narrative Frame is the "
            "entire multi-region board, not one region or a summary. A six-region "
            "board should use roughly 450 to 650 words, or equivalent detail in "
            "the requested language, so every region is independently renderable. "
