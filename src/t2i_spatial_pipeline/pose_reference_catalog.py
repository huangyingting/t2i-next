...
def build_neutral_pose_library() -> NeutralPoseLibrary:
    ...
    left_mat = SupportContact(body_part="left_hand", surface="mat", load_bearing=False)
    ...
    poses = (
        ...
        _pose(
            ...
            right="on_knee",
            supports=(_LEFT_KNEE, _RIGHT_FOOT),
            cameras=_LOW_CAMERAS,
        ),
        _pose(
            "half_kneeling",
            ...
            left="on_knee",
            supports=(_RIGHT_KNEE, _LEFT_FOOT),
            cameras=_LOW_CAMERAS,
        ),
        _pose(
            "half_kneeling",
        ...
        _pose(
            ...
            spine="forward_inclined",
            silhouette="folded",
            legs="bent_knees_feet_flat",
            left="on_floor",
            right="on_knee",
            supports=(*feet, left_floor),
            cameras=_LOW_CAMERAS,
        ),
        _pose(
            "crouched_supported",
        ...
        _pose(
            ...
            left="on_floor",
            right="on_floor",
            supports=(*feet, left_floor, right_floor),
            cameras=_LOW_CAMERAS,
        ),
        _pose(
            "side_lying_rest",
